...
o.bind("SUPER + D", "Dismiss all notifications", "omarchy-shell notifications dismissAll")
o.bind("SUPER + ALT + D", "Invoke last notification", "omarchy-shell notifications invokeLast")
o.bind("SUPER + SHIFT + ALT + D", "Open notification history", "omarchy-shell notifications showHistory")
...
o.bind("SUPER + R", "Set reminder", "omarchy-menu toggle reminder-set")
o.bind("SUPER + ALT + R", "Show reminders", "omarchy-reminder show")
o.bind("SUPER + SHIFT + R", "Clear reminders", "omarchy-reminder clear")
